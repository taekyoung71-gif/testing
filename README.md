...
The repo includes a static landing page (`index.html`) that references the SVG assets. Deploy by hosting the repository root on any static host (GitHub Pages, Netlify, S3, etc.).
